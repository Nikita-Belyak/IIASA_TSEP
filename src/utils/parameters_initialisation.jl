...
id_slope, id_intercept = lif_slope_and_intercept_generation(data_src_link, N_nodes, N_scen, T, hours_for_each_scenario)
...
TRANSM = transmission_parameters(L_max, M_lines, I_lines)
