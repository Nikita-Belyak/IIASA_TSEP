...
g_e = sum(value.(single_level_problem[:g_VRES_plus]))
g_conv = sum(value.(single_level_problem[:g_conv_plus]))
g_e*100/(g_e+g_conv)
...
g_e = sum(value.(bi_level_problem_cournot[:g_VRES_plus]))
g_conv = sum(value.(bi_level_problem_cournot[:g_conv_plus]))
g_e*100/(g_e+g_conv)
...
g_e = sum(value.(bi_level_problem_perfect[:g_VRES_plus]))
g_conv = sum(value.(bi_level_problem_perfect[:g_conv_plus]))
g_e*100/(g_e+g_conv)
