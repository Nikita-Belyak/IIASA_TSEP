...
print_output(data_src_link, input_parameters, objective_value(single_level_problem), value.(single_level_problem[:l_plus]), value.(single_level_problem[:g_VRES_plus]) , value.(single_level_problem[:g_conv_plus]), value.(single_level_problem[:g_VRES]), value.(single_level_problem[:g_conv]), value.(single_level_problem[:f]), "single_level", scaling_factor)
...
print_output(data_src_link, input_parameters, objective_value(bi_level_problem_cournot), value.(bi_level_problem_cournot[:l_plus]), value.(bi_level_problem_cournot[:g_VRES_plus]) , value.(bi_level_problem_cournot[:g_conv_plus]), value.(bi_level_problem_cournot[:g_VRES]), value.(bi_level_problem_cournot[:g_conv]), value.(bi_level_problem_cournot[:f]), "bi_level_cournot", scaling_factor)
...
print_output(data_src_link, input_parameters, objective_value(bi_level_problem_perfect), value.(bi_level_problem_perfect[:l_plus]), value.(bi_level_problem_perfect[:g_VRES_plus]) , value.(bi_level_problem_perfect[:g_conv_plus]), value.(bi_level_problem_perfect[:g_VRES]), value.(bi_level_problem_perfect[:g_conv]), value.(bi_level_problem_perfect[:f]), "bi_level_perfect", scaling_factor)